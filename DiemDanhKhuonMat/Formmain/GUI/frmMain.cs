    ...
    public partial class Form1 : Form
    {
        ...
        private void HienThiChiTietSV(frmSuaSV frm)
        {
            ...
            if (reader.Read() == true)
            {
                ...
                frm.txtSMaSV.Text = reader.GetString(0);
                ...
                {
                    frm.radsNam.Checked = true;
                }
                else
                {
                    frm.radsNu.Checked = true;
                }
                connect.Close();
            }
        }

        private void sửaThôngTinSinhVienToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmSuaSV frm = new frmSuaSV();
            HienThiChiTietSV(frm);
        }

        private void toolStripButton4_Click(object sender, EventArgs e)
        {
            điểmDanhToolStripMenuItem_Click(sender, e);
        }

        private void mởRộngTreeviewToolStripMenuItem_Click(object sender, EventArgs e)
        {
